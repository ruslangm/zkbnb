...
replace (
	github.com/bnb-chain/zkbnb-crypto => github.com/ruslangm/zkbnb-crypto v0.0.8-0.20230123153624-f2dc64c73feb
	github.com/consensys/gnark => github.com/ruslangm/gnark v0.7.1-0.20230123144620-0784e6315ef4
